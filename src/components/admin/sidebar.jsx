...
const SideBar = ({ isClicked, onClick, onHover, onUnhover }) => {
    return (
        <div className={`sidebar-container ${isClicked ? 'sidebar-open' : ''}`} onMouseOver={onHover} onMouseOut={onUnhover}>
            ...
            <ul className='iconS'>
                <li>
                    <SideBarLink direct='/create-student'  title='Enroll Student' isClicked={isClicked} />
                </li>
                <li>
                    <SideBarLink direct='/create-professor' title='Enlist a Professor  ' isClicked={isClicked} />
                </li>
                <li>
                    <SideBarLink direct='/create-admin'  title='Admin Registration' isClicked={isClicked} />
                </li>
                <li>
                    <SideBarLink direct='/create-subject'  title='Subject Registration' isClicked={isClicked} />
                </li>
                <li>
                    <SideBarLink direct='/create-class' title='Assigning Professor' isClicked={isClicked} />
                </li>
                <li>
                    <SideBarLink direct='/enroll-student-class'  title='Students Assigned Class' isClicked={isClicked} />
                </li>
